...
account_jan = Account.create!(first_name: 'Jan', last_name: 'Novák', birthdate: '1990-05-15', address: '', phone: '123456789', member_code: 'MN001', role: 'superadmin', email: 'jan@example.com', status: :verified)
account_anna = Account.create!(first_name: 'Anna', last_name: 'Svobodová', birthdate: '1985-03-22', address: '', phone: '987654321', member_code: 'MN002', role: 'nothing', email: 'anna@example.com', status: :verified)
